...
ENV PHP_EXTRA_BUILD_DEPS python unzip libpcre3-dev
...
RUN apt-get update \
   ...
   && docker-php-ext-install pdo_mysql intl mbstring soap bz2 mcrypt xmlrpc zip bcmath imap gd xsl calendar opcache amqp \
   \
   # PECL
